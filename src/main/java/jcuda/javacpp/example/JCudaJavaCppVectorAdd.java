...
import jcuda.javacpp.example.preloads.JCudaJavaCppPreloads;
import jcuda.nvrtc.JNvrtc;
import jcuda.nvrtc.nvrtcProgram;

/**
 * An example showing how to preload the CUDA runtime libraries with
 * the infrastructure of https://github.com/bytedeco/javacpp .
 * 
 * Except for the call that preloads the libraries, this is the same as the
 * JNvrtcVectorAdd sample from https://github.com/jcuda/jcuda-samples/
 */
public class JCudaJavaCppVectorAdd
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        // This line is the only difference to the original vector addition
        // example: It causes the required CUDA libraries to be loaded, 
        // with the version that is defined in the pom.xml, using the 
        // JavaCPP infrastructure:
        JCudaJavaCppPreloads.preloadCuda();
